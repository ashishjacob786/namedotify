...
export default function HostingPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans pb-20 pt-28">
      ...
      {/* ✅ 2. Advanced SEO Tags */}
      <title>Free Web Hosting Checker - Who Hosts This Website? | NameDotify.com</title>
      <meta name="description" content="Find out who hosts any website instantly. Detect WordPress hosting, Cloudflare, AWS, and server location with our free Hosting Checker tool." />
      <meta name="keywords" content="hosting checker, who hosts this website, check web hosting, find website host, server location finder, detect cloudflare" />
      
      {/* ✅ 3. Open Graph Tags */}
      <meta property="og:title" content="Free Web Hosting Checker | NameDotify.com" />
      <meta property="og:description" content="Discover the hosting provider behind any domain." />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://namedotify.com/hosting" />
