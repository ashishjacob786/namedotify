        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-4">
                ...
                <div className="pt-2">
                    ...
                    <a 
                        ...
                        className="block text-sm font-medium text-blue-600 hover:text-blue-800 transition flex items-center gap-1"
                    >
                        Sneric Pacific LLP <ExternalLink size={12} />
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <ul className="space-y-3">
                    ...
                    <li>
                        <a href="#" className="text-base text-gray-500 hover:text-blue-600 transition">
            ...
            <div>
                ...
                <ul className="space-y-3">
                    ...
                    <li>
                        <a href="#" className="text-base text-gray-500 hover:text-blue-600 transition">Privacy Policy</a>
                    </li>
                    <li>
                        <a href="#" className="text-base text-gray-500 hover:text-blue-600 transition">Terms of Service</a>
                    </li>
                    <li>
                        <a href="#" className="text-base text-gray-500 hover:text-blue-600 transition">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
